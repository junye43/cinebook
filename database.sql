-- ============================================================
-- CineBook Cinema Ticket Booking System — Base Version
-- Complete, self-contained schema + sample data.
--
-- HOW TO IMPORT (phpMyAdmin):
--   1. Click "Import" on the phpMyAdmin home page (no database needs to
--      be selected — this file creates it).
...
-- ---------------------------------------------------
-- MOVIE (shown at -> Cinema)
--   Poster      = card image file in images/posters/
--   Backdrop    = wide hero image file in images/backdrops/
--   Certificate = film rating (e.g. PG13, NC16)
--   Stars       = editorial star rating 1-5
--   Status      = 'showing' or 'coming'
-- ---------------------------------------------------
CREATE TABLE movie (
...
-- ---------------------------------------------------
-- RESERVATION (made by <- Customer, for -> Movie)
-- ---------------------------------------------------
...
-- ---------------------------------------------------
-- TRANSACTION (for -> Payment_type, Customer, Reservation)
-- ---------------------------------------------------
...
-- Now Showing (Poster + Backdrop image files live in images/posters and images/backdrops)
...
('Hall 1', '2026-09-20', '14:30:00', 'A brilliant neurosurgeon is drawn into the world of the mystic arts on a journey of physical and spiritual healing, confronting a danger that threatens the entire multiverse.', 'Stellar Horizon',     'stellarhorizon.png',    'stellarhorizonposter.png',    'Sci-Fi', 128, 'PG13', 5, 'showing', 1),
('Hall 2', '2026-09-20', '18:00:00', 'A heartwarming story of friendship and courage set on a remote coast, following a keeper who guards more than just the light.',                                          'The Last Lighthouse', 'thelastlighthouse.png', 'thelastlighthouseposter.png', 'Drama',  105, 'PG',   4, 'showing', 1),
('Hall 1', '2026-09-21', '20:15:00', 'Non-stop action as an elite team races against time to stop a global threat hidden in plain sight.',                                                                        'Midnight Protocol',   'midnightprotocol.png',  'midnightprotocolposter.png',  'Action', 115, 'NC16', 3, 'showing', 2),
('Hall 3', '2026-09-21', '16:00:00', 'A laugh-out-loud comedy about a chaotic family weekend that spirals hilariously out of control.',                                                                         'Weekend Warriors',    'weekendwarriors.png',   'weekendwarriorsposter.png',   'Comedy',  98, 'PG',   4, 'showing', 2),
('Hall 2', '2026-09-22', '19:30:00', 'A gripping thriller where nothing is as it seems and every clue leads deeper into the dark.',                                                                             'Silent Echo',         'silentecho.png',        'silentechoposter.png',        'Action', 122, 'M18',  4, 'showing', 1),
('Hall 4', '2026-09-22', '15:15:00', 'An animated adventure across enchanted lands, full of heart, wonder and unlikely heroes.',                                                                              'Painted Skies',       'paintedskies.png',      'paintedskiesposter.png',      'Comedy',  92, 'PG',   5, 'showing', 2);
